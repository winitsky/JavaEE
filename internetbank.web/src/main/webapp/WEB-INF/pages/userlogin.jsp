...
<link href="<c:url value="/bootstrap/css/signin.css" />"
 rel="stylesheet">
...
<body>
 ...
 <div class="container" style="width: 300px;">
  ...
  <form action="${loginUrl}" method="post">
   <h2 class="form-signin-heading">Please sign in Internet Bank
    application</h2>
   ...
   <button class="btn btn-lg btn-primary btn-block" type="submit">Enter</button>
    ...
    <!--  <button href="<c:url value="/registration" />" role="button">Registration</button>-->
